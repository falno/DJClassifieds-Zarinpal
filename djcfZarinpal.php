...
$lang->load('plg_djclassifiedspayment_djcfZarinpal',JPATH_ADMINISTRATOR);
...
class plgdjclassifiedspaymentdjcfZarinpal extends JPlugin
{
	// constructor
	function plgdjclassifiedspaymentdjcfZarinpal( &$subject, $config)
	{
		parent::__construct($subject, $config);
		$this->loadLanguage('plg_djcfZarinpal');
		$params["plugin_name"] = "djcfZarinpal";
		$params["logo"] = "zarinpal_overview.png";
		$params["description"] = JText::_("PLG_DJCFZARINPAL_PAYMENT_METHOD_DESC");
		$params["payment_method"] = JText::_("PLG_DJCFZARINPAL_PAYMENT_METHOD_NAME");
 ...
 */
	...
	function onPaymentMethodList($val)
	{
		...
		if($this->params["merchant_id"] != ''){
			$payText =  JText::_("PLG_DJCFZARINPAL_PAYMENT_PAY");
